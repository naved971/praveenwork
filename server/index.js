...
app.get('/rcno/getFieldInfo', (req, res) => {
    ...
    responseData["fieldNameMap"] = { "FFM Last Name": "FFM_MBR_LAST_NM", "FFM Member Middle Name": "FFM_MBR_MIDL_NM", "FFM DOB": "FFM_BTH_DT", "Issuer Exchange Assigned Member ID": "ISUR_EXCH_ASGD_MBR_ID", "FFM Issuer Assigned Policy ID": "FFM_ISUR_PLCY_ID", "FFM Member First Name": "FFM_MBR_1ST_NM", "Issuer DOB": "ISUR_BTH_DT", "FFM Issuer Assigned Subscriber ID": "FFM_ISUR_ASGD_SUBR_ID", "Issuer Member Last Name": "ISUR_MBR_LAST_NM", "Issuer Issuer Assigned Policy ID": "ISUR_ISUR_PLCY_ID", "Issuer Member First Name": "ISUR_MBR_1ST_NM", "FFM SSN": "FFM_SSN_NB", "Issuer QHPID Identifier": "ISUR_QHP_ID", "FFM Exchange Assigned Policy ID": "FFM_EXCH_ASGD_PLCY_ID", "Issuer Issuer Assigned Subscriber ID": "ISUR_ISUR_ASGD_SUBR_ID", "FFM Coverage Year": "FFM_COVA_YR_NB", "FFM Issuer Assigned Member ID": "FFM_ISUR_ASGD_MBR_ID", "FTI Issuer Overall Record Flag": "FTI_ISUR_OVAL_REC_IN", "Issuer SSN": "ISUR_SSN_NB", "FFM QHPID Identifier": "FFM_QHP_ID", "FFM Exchange Assigned Subscriber ID": "FFM_EXCH_ASGD_SUBR_ID", "Issuer Exchange Assigned Policy ID": "ISUR_EXCH_ASGD_PLCY_ID", "Issuer Coverage Year": "ISUR_COVA_YR_NB", "Issuer Assigned Trace Number": "FTI_ISUR_ASGD_REC_TRAC_NB", "Issuer Issuer Assigned Member ID": "ISUR_ISUR_ASGD_MBR_ID", "Issuer Member Middle Name": "ISUR_MBR_MIDL_NM", "Issuer Exchange Assigned Subscriber ID": "ISUR_EXCH_ASGD_SUBSR_ID", "FFM Exchange Assigned Member ID": "FFM_EXCH_ASGD_MBR_ID" };
