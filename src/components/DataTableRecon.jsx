...
import DataTableCellRecon from './DataTableCellRecon';
...
class DataTableRecon extends Component {
    renderColumns(headerFields, data) {
        ...
        return headerFields.map(datum => {
            return <Column
                ...
                cell={<DataTableCellRecon data={data} col={datum.id} link={datum.link}/>}
...
DataTableRecon.propTypes = propTypes
export default DataTableRecon
